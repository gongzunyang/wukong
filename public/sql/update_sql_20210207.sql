...
ALTER TABLE `5kcrm_crm_contract` ADD COLUMN `expire_remind` tinyint(1) NOT NULL DEFAULT 1  COMMENT '是否提醒合同到期：1提醒；0提醒';
...
ALTER TABLE `5kcrm_crm_business` ADD COLUMN `expire_remind` tinyint(1) NOT NULL DEFAULT 1  COMMENT '是否提醒：1提醒；0提醒';
