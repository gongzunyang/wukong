...
CREATE TABLE `5kcrm_admin_examine_record` (
  ...
  `check_user_id` int(11) NOT NULL COMMENT '审批人ID',
  ...
  `is_end` tinyint(1) NOT NULL COMMENT '审批失效（1标记为无效）',
...
INSERT INTO `5kcrm_admin_field` VALUES ('1', '', '0', 'create_user_id', '创建人', 'user', '', '0', '0', '0', '', '', '0', '3', '1553788800', '1553788800', '0');
INSERT INTO `5kcrm_admin_field` VALUES ('2', '', '0', 'update_time', '更新时间', 'datetime', '', '0', '0', '0', '', '', '0', '3', '1553788800', '1553788800', '0');
INSERT INTO `5kcrm_admin_field` VALUES ('3', '', '0', 'create_time', '创建时间', 'datetime', '', '0', '0', '0', '', '', '0', '3', '1553788800', '1553788800', '0');
INSERT INTO `5kcrm_admin_field` VALUES ('4', '', '0', 'owner_user_id', '负责人', 'user', '', '0', '0', '0', '', '', '0', '3', '1553788800', '1553788800', '0');
...
CREATE TABLE `5kcrm_crm_achievement` (
  ...
  `type` tinyint(2) NOT NULL COMMENT '1公司2部门3员工',
...
CREATE TABLE `5kcrm_crm_business` (
  ...
  `deal_date` date NOT NULL COMMENT '预计成交日期',
...
CREATE TABLE `5kcrm_crm_receivables` (
  ...
  `customer_id` int(11) NOT NULL COMMENT '客户ID',
  `contract_id` int(11) NOT NULL COMMENT '合同ID',
  `return_time` date NOT NULL COMMENT '回款日期',
...
DROP TABLE IF EXISTS `5kcrm_hrm_log`;
CREATE TABLE `5kcrm_hrm_log` (
  `log_id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '操作人',
  `content` varchar(255) NOT NULL DEFAULT '' COMMENT '操作详情',
  `update_user_id` int(11) NOT NULL COMMENT '操作人ID',
  `status` tinyint(2) DEFAULT '0' COMMENT '状态',
  `create_time` int(11) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`log_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='员工档案操作日志表';

DROP TABLE IF EXISTS `5kcrm_hrm_memo`;
CREATE TABLE `5kcrm_hrm_memo` (
  `memo_id` int(11) NOT NULL AUTO_INCREMENT,
  `content` text COMMENT '备忘录内容',
  `create_time` int(11) NOT NULL COMMENT '新建时间',
  `set_time` int(11) NOT NULL DEFAULT '0' COMMENT '设定时间',
...
DROP TABLE IF EXISTS `5kcrm_hrm_pact`;
CREATE TABLE `5kcrm_hrm_pact` (
  `pact_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '合同ID',
  `pact_num` varchar(50) NOT NULL DEFAULT '' COMMENT '合同编号',
  `type` varchar(150) NOT NULL DEFAULT '' COMMENT '合同类型',
  `start_time` int(11) NOT NULL DEFAULT '0' COMMENT '开始日期',
  `stop_time` int(11) NOT NULL DEFAULT '0' COMMENT '截至日期',
  `limit_time` tinyint(2) NOT NULL DEFAULT '0' COMMENT '合同期限（年）',
  `status` tinyint(2) NOT NULL DEFAULT '0' COMMENT '合同状态1：执行中 2：已到期 3：未执行',
  `create_time` int(11) NOT NULL COMMENT '创建签订日期',
  `remark` varchar(255) NOT NULL DEFAULT '' COMMENT '备注',
  `user_id` int(11) NOT NULL COMMENT '员工ID',
  `update_time` int(11) NOT NULL COMMENT '编辑时间',
  `company` varchar(100) NOT NULL DEFAULT '' COMMENT '签约公司',
  PRIMARY KEY (`pact_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

DROP TABLE IF EXISTS `5kcrm_hrm_parroll`;
CREATE TABLE `5kcrm_hrm_parroll` (
  `parroll_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '工资信息表',
  `user_id` int(11) NOT NULL COMMENT '用户ID',
  `status` tinyint(2) DEFAULT '1' COMMENT '1正常使用2不可用',
  `time` varchar(20) NOT NULL DEFAULT '' COMMENT '日期',
  `ischeck` tinyint(2) DEFAULT '0' COMMENT '是否审核 1审核',
  `remark` varchar(255) NOT NULL DEFAULT '' COMMENT '备注',
  `base_pay` decimal(9,2) DEFAULT '0.00' COMMENT '基本工资',
  `snow_oewida` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '根据岗位、责任、技能要求等，不同岗位，工资不同。',
  `snow_pedgxh` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '根据职务高低、业务技术水平等因素的不同，工资不同，随职务变动而变动。',
  `snow_emccja` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '以员工的实际劳动成果或表现为考核标准，支付一定的奖励工资。',
  `snow_apgmbg` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '对于按公司规定到岗工作，未出现任何迟到、早退的员工给予的奖励，一般以月度为考核期限。',
  `snow_zfzbcv` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '新入职、离职员工，不在职的工作日，需从工资里扣除这些工作日的工资',
  `snow_fltooj` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '员工无故迟到，需扣除一定的工资作为惩戒',
  `nowork` decimal(18,2) DEFAULT '0.00' COMMENT '旷工（系统项）',
  `late` decimal(18,2) DEFAULT '0.00' COMMENT '迟到 （系统项）',
  `leave` decimal(18,2) DEFAULT '0.00' COMMENT '不在职，免发（系统项）',
  `vacation` decimal(18,2) DEFAULT '0.00' COMMENT '假期（系统项）',
  `zaotui` decimal(18,2) DEFAULT '0.00' COMMENT '早退（系统项）',
  `snow_jixiao` decimal(18,2) DEFAULT '0.00',
  `snow_whnqyx` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '车补',
  `snow_buxawu` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '工龄工资',
  `snow_mosojp` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '技能工资',
  `snow_yvlqeb` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '测试1工资',
  `snow_hurzus` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '测试2工资',
  `snow_uxhsqc` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '测试3工资',
  `snow_sjhhyb` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '工资4工资',
  `snow_rzsegi` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '工资5工资',
  PRIMARY KEY (`parroll_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='员工薪资信息表';

DROP TABLE IF EXISTS `5kcrm_hrm_parroll_fieldstatus`;
CREATE TABLE `5kcrm_hrm_parroll_fieldstatus` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '薪资系统字段状态',
  `field` varchar(15) NOT NULL COMMENT '字段',
  `status` tinyint(2) DEFAULT '1' COMMENT '状态 1正常',
  `remark` varchar(100) NOT NULL DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

INSERT INTO `5kcrm_hrm_parroll_fieldstatus` VALUES ('1', 'nowork', '0', '旷工');
INSERT INTO `5kcrm_hrm_parroll_fieldstatus` VALUES ('2', 'late', '1', '迟到');
INSERT INTO `5kcrm_hrm_parroll_fieldstatus` VALUES ('3', 'zaotui', '1', '早退');
INSERT INTO `5kcrm_hrm_parroll_fieldstatus` VALUES ('4', 'vacation', '1', '假期');
INSERT INTO `5kcrm_hrm_parroll_fieldstatus` VALUES ('5', 'leave', '1', '离职');
INSERT INTO `5kcrm_hrm_parroll_fieldstatus` VALUES ('6', 'alladd', '1', '所有浮动工资');
INSERT INTO `5kcrm_hrm_parroll_fieldstatus` VALUES ('7', 'allsub', '1', '所有 扣除项');

DROP TABLE IF EXISTS `5kcrm_hrm_parroll_list`;
CREATE TABLE `5kcrm_hrm_parroll_list` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL COMMENT '员工ID',
  `realname` varchar(255) NOT NULL COMMENT '员工姓名',
  `base` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '基本工资',
  `adds` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '浮动工资',
  `sub` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '扣除工资',
  `add_remark` varchar(255) NOT NULL DEFAULT '' COMMENT '浮动工资备注',
  `sub_remark` varchar(255) NOT NULL DEFAULT '' COMMENT '扣除工资备注',
  `time` varchar(100) NOT NULL DEFAULT '' COMMENT '时间',
  `sum` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '合计',
  `create_time` int(11) NOT NULL COMMENT '生成时间',
  `ischeck` tinyint(2) NOT NULL DEFAULT '0' COMMENT '是否审核，1审核 审核通过后不能修改',
  ...
  `remark` varchar(255) NOT NULL DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='员工薪资表';

DROP TABLE IF EXISTS `5kcrm_hrm_user_bank`;
CREATE TABLE `5kcrm_hrm_user_bank` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '银行卡',
  `num` varchar(30) NOT NULL DEFAULT '' COMMENT '银行卡号',
  `bank` varchar(100) NOT NULL DEFAULT '' COMMENT '开户行',
  `bankdet` varchar(255) NOT NULL DEFAULT '' COMMENT '开户支行',
  `phone` varchar(14) NOT NULL DEFAULT '' COMMENT '手机号',
  `create_time` int(11) NOT NULL COMMENT '创建时间',
  `update_time` int(11) NOT NULL COMMENT '编辑时间',
  `user_id` int(11) NOT NULL COMMENT '员工ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='员工银行卡表';
...
CREATE TABLE `5kcrm_hrm_user_det` (
  ...
  `leave_time` int(11) NOT NULL DEFAULT '' COMMENT '离职时间',
...
CREATE TABLE `5kcrm_oa_event` (
  ...
  `title` varchar(255) NOT NULL DEFAULT '0' COMMENT '日程标题',
  `start_time` int(11) NOT NULL  COMMENT '开始时间',
  `end_time` int(11) NOT NULL COMMENT '结束时间',
  `create_user_id` int(10) NOT NULL COMMENT '创建人ID',
  `create_time` int(11) NOT NULL COMMENT '创建时间',
